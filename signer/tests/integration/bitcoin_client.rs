...
#[tokio::test]
async fn test_get_block_not_found_serialgroup() {
    let url: Url = format!(
...
#[tokio::test]
async fn test_get_block_works_serialgroup() {
...
#[tokio::test]
async fn calculate_transaction_fee_works_confirmed_serialgroup() {
...
#[tokio::test]
async fn calculate_transaction_fee_works_mempool_serialgroup() {
    let client = BitcoinCoreClient::new(
        regtest::BITCOIN_CORE_RPC_ENDPOINT,
        regtest::BITCOIN_CORE_RPC_USERNAME.to_string(),
        regtest::BITCOIN_CORE_RPC_PASSWORD.to_string(),
